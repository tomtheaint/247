...
export function BottomNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 inset-x-0 z-30 bg-gray-900 border-t border-gray-700 safe-area-bottom">
      <div className="flex items-center justify-around px-2 py-1">
        ...
        {(role === "ADMIN" || role === "REVIEWER") && (
          <NavLink
            to="/reviewer"
            className={({ isActive }) =>
              clsx("flex flex-col items-center gap-0.5 px-3 py-2 rounded-xl transition-colors min-w-0",
                isActive ? "text-brand-400" : "text-gray-400 hover:text-gray-200")
            }
          >
            <svg className="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            <span className="text-[10px] font-medium leading-none">Review</span>
          </NavLink>
        )}
      </div>
    </nav>
